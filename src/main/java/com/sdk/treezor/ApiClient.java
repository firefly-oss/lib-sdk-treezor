...
import com.sdk.treezor.auth.Authentication;
import com.sdk.treezor.auth.HttpBasicAuth;
import com.sdk.treezor.auth.HttpBearerAuth;
import com.sdk.treezor.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://baseURL.co";
    ...
    /**
     * Constructor that takes a Configuration object to initialize the ApiClient.
     * 
     * @param configuration The Configuration object containing API settings
     */
    public ApiClient(Configuration configuration) {
        this();
        if (configuration.getBaseUrl() != null) {
            this.setBasePath(configuration.getBaseUrl());
        }
        if (configuration.getAccessToken() != null) {
            this.setAccessToken(configuration.getAccessToken());
        }
    }
