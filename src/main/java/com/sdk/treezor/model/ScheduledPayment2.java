 ...
 */
@JsonPropertyOrder({
  ScheduledPayment2.JSON_PROPERTY_ID,
  ScheduledPayment2.JSON_PROPERTY_STATUS,
  ScheduledPayment2.JSON_PROPERTY_SCHEDULED_PAYMENT_NAME,
  ScheduledPayment2.JSON_PROPERTY_WALLET_ID,
  ScheduledPayment2.JSON_PROPERTY_BENEFICIARY_TYPE,
  ScheduledPayment2.JSON_PROPERTY_BENEFICIARY,
  ScheduledPayment2.JSON_PROPERTY_AMOUNT,
  ScheduledPayment2.JSON_PROPERTY_TYPE,
  ScheduledPayment2.JSON_PROPERTY_EXEC_AT,
  ScheduledPayment2.JSON_PROPERTY_START_AT,
  ScheduledPayment2.JSON_PROPERTY_END_AT,
  ScheduledPayment2.JSON_PROPERTY_CREATION_DATE,
  ScheduledPayment2.JSON_PROPERTY_PERIOD,
  ScheduledPayment2.JSON_PROPERTY_BENEFICIARY_LABEL,
  ScheduledPayment2.JSON_PROPERTY_CURRENCY,
  ScheduledPayment2.JSON_PROPERTY_USER_ID,
  ScheduledPayment2.JSON_PROPERTY_AMR,
  ScheduledPayment2.JSON_PROPERTY_FAILED_PAYMENT,
  ScheduledPayment2.JSON_PROPERTY_END_TO_END_ID
})
@JsonTypeName("ScheduledPayment_2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-04-14T09:49:28.273669400+02:00[Europe/Paris]", comments = "Generator version: 7.12.0")
public class ScheduledPayment2 {
  ...
  public ScheduledPayment2() {
  }

  public ScheduledPayment2 id(@javax.annotation.Nullable UUID id) {
  ...
  public ScheduledPayment2 status(@javax.annotation.Nullable StatusEnum status) {
  ...
  public ScheduledPayment2 scheduledPaymentName(@javax.annotation.Nullable String scheduledPaymentName) {
  ...
  public ScheduledPayment2 walletId(@javax.annotation.Nullable Integer walletId) {
  ...
  public ScheduledPayment2 beneficiaryType(@javax.annotation.Nullable BeneficiaryTypeEnum beneficiaryType) {
  ...
  public ScheduledPayment2 beneficiary(@javax.annotation.Nullable Integer beneficiary) {
  ...
  public ScheduledPayment2 amount(@javax.annotation.Nullable Float amount) {
  ...
  public ScheduledPayment2 type(@javax.annotation.Nullable TypeEnum type) {
  ...
  public ScheduledPayment2 execAt(@javax.annotation.Nullable LocalDate execAt) {
  ...
  public ScheduledPayment2 startAt(@javax.annotation.Nullable LocalDate startAt) {
  ...
  public ScheduledPayment2 endAt(@javax.annotation.Nullable LocalDate endAt) {
  ...
  public ScheduledPayment2 creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public ScheduledPayment2 period(@javax.annotation.Nullable PeriodEnum period) {
  ...
  public ScheduledPayment2 beneficiaryLabel(@javax.annotation.Nullable String beneficiaryLabel) {
  ...
  public ScheduledPayment2 currency(@javax.annotation.Nullable String currency) {
  ...
  public ScheduledPayment2 userId(@javax.annotation.Nullable String userId) {
  ...
  public ScheduledPayment2 amr(@javax.annotation.Nullable List<String> amr) {
    
    this.amr = amr;
    return this;
  }

  public ScheduledPayment2 addAmrItem(String amrItem) {
    if (this.amr == null) {
  ...
  public ScheduledPayment2 failedPayment(@javax.annotation.Nullable List<ScheduledPaymentFailedPaymentInner> failedPayment) {
    
    this.failedPayment = failedPayment;
    return this;
  }

  public ScheduledPayment2 addFailedPaymentItem(ScheduledPaymentFailedPaymentInner failedPaymentItem) {
  ...
  public ScheduledPayment2 endToEndId(@javax.annotation.Nullable String endToEndId) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduledPayment2 scheduledPayment2 = (ScheduledPayment2) o;
    return Objects.equals(this.id, scheduledPayment2.id) &&
        Objects.equals(this.status, scheduledPayment2.status) &&
        Objects.equals(this.scheduledPaymentName, scheduledPayment2.scheduledPaymentName) &&
        Objects.equals(this.walletId, scheduledPayment2.walletId) &&
        Objects.equals(this.beneficiaryType, scheduledPayment2.beneficiaryType) &&
        Objects.equals(this.beneficiary, scheduledPayment2.beneficiary) &&
        Objects.equals(this.amount, scheduledPayment2.amount) &&
        Objects.equals(this.type, scheduledPayment2.type) &&
        Objects.equals(this.execAt, scheduledPayment2.execAt) &&
        Objects.equals(this.startAt, scheduledPayment2.startAt) &&
        Objects.equals(this.endAt, scheduledPayment2.endAt) &&
        Objects.equals(this.creationDate, scheduledPayment2.creationDate) &&
        Objects.equals(this.period, scheduledPayment2.period) &&
        Objects.equals(this.beneficiaryLabel, scheduledPayment2.beneficiaryLabel) &&
        Objects.equals(this.currency, scheduledPayment2.currency) &&
        Objects.equals(this.userId, scheduledPayment2.userId) &&
        Objects.equals(this.amr, scheduledPayment2.amr) &&
        Objects.equals(this.failedPayment, scheduledPayment2.failedPayment) &&
        Objects.equals(this.endToEndId, scheduledPayment2.endToEndId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduledPayment2 {\n");
