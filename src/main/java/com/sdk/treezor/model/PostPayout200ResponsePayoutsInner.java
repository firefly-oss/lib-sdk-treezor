 ...
 */
@JsonPropertyOrder({
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_PAYOUT_ID,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_PAYOUT_TAG,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_PAYOUT_STATUS,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_PAYOUT_TYPE_ID,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_PAYOUT_TYPE,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_WALLET_ID,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_PAYOUT_DATE,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_WALLET_EVENT_NAME,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_WALLET_ALIAS,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_USER_FIRSTNAME,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_USER_LASTNAME,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_USER_ID,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_BENEFICIARY_ID,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_UNIQUE_MANDATE_REFERENCE,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_BANKACCOUNT_I_B_A_N,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_VIRTUAL_IBAN_ID,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_VIRTUAL_IBAN_REFERENCE,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_LABEL,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_END_TO_END_ID,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_REASON_CODE,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_REASON_DESCRIPTION,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_CODE_STATUS,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_INFORMATION_STATUS,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_SUPPORTING_FILE_LINK,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_AMOUNT,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_CURRENCY,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_PARTNER_FEE,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_CREATED_DATE,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_MODIFIED_DATE,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_TOTAL_ROWS,
  PostPayout200ResponsePayoutsInner.JSON_PROPERTY_METADATA
})
@JsonTypeName("postPayout_200_response_payouts_inner")
...
public class PostPayout200ResponsePayoutsInner {
  ...
  public PostPayout200ResponsePayoutsInner payoutTypeId(@javax.annotation.Nullable PayoutTypeIdEnum payoutTypeId) {
  ...
  public PostPayout200ResponsePayoutsInner amount(@javax.annotation.Nullable Float amount) {
  ...
  public PostPayout200ResponsePayoutsInner createdDate(@javax.annotation.Nullable OffsetDateTime createdDate) {
  ...
  public PostPayout200ResponsePayoutsInner modifiedDate(@javax.annotation.Nullable OffsetDateTime modifiedDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payoutId, postPayout200ResponsePayoutsInner.payoutId) &&
        ...
        equalsNullable(this.virtualIbanId, postPayout200ResponsePayoutsInner.virtualIbanId) &&
        equalsNullable(this.virtualIbanReference, postPayout200ResponsePayoutsInner.virtualIbanReference) &&
        ...
        equalsNullable(this.reasonCode, postPayout200ResponsePayoutsInner.reasonCode) &&
        equalsNullable(this.reasonDescription, postPayout200ResponsePayoutsInner.reasonDescription) &&
        ...
        equalsNullable(this.metadata, postPayout200ResponsePayoutsInner.metadata);
  }
