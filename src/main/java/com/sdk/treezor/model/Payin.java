 ...
 */
@JsonPropertyOrder({
  Payin.JSON_PROPERTY_MESSAGE_TO_USER,
  Payin.JSON_PROPERTY_CODE_STATUS,
  Payin.JSON_PROPERTY_INFORMATION_STATUS,
  Payin.JSON_PROPERTY_PAYMENT_METHOD_ID,
  Payin.JSON_PROPERTY_PAYIN_TAG,
  Payin.JSON_PROPERTY_ADDITIONAL_DATA,
  Payin.JSON_PROPERTY_IBAN_FULLNAME,
  Payin.JSON_PROPERTY_IBAN_BIC,
  Payin.JSON_PROPERTY_DBTR_I_B_A_N,
  Payin.JSON_PROPERTY_MANDATE_ID,
  Payin.JSON_PROPERTY_IBAN_TX_END_TO_END_ID,
  Payin.JSON_PROPERTY_PAYIN_ID,
  Payin.JSON_PROPERTY_DEBTOR_NAME,
  Payin.JSON_PROPERTY_UNIQUE_MANDATE_REFERENCE
})
...
public class Payin {
  ...
  public Payin paymentMethodId(@javax.annotation.Nullable Integer paymentMethodId) {
  ...
  public Payin ibanBic(@javax.annotation.Nullable String ibanBic) {
  ...
  public boolean equals(Object o) {
    ...
    Payin payin = (Payin) o;
    return equalsNullable(this.messageToUser, payin.messageToUser) &&
        Objects.equals(this.codeStatus, payin.codeStatus) &&
        equalsNullable(this.informationStatus, payin.informationStatus) &&
        Objects.equals(this.paymentMethodId, payin.paymentMethodId) &&
        equalsNullable(this.payinTag, payin.payinTag) &&
        equalsNullable(this.additionalData, payin.additionalData) &&
        equalsNullable(this.ibanFullname, payin.ibanFullname) &&
        equalsNullable(this.ibanBic, payin.ibanBic) &&
        equalsNullable(this.dbtrIBAN, payin.dbtrIBAN) &&
        equalsNullable(this.mandateId, payin.mandateId) &&
        equalsNullable(this.ibanTxEndToEndId, payin.ibanTxEndToEndId) &&
        Objects.equals(this.payinId, payin.payinId) &&
        equalsNullable(this.debtorName, payin.debtorName) &&
        equalsNullable(this.uniqueMandateReference, payin.uniqueMandateReference);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(messageToUser), codeStatus, hashCodeNullable(informationStatus), paymentMethodId, hashCodeNullable(payinTag), hashCodeNullable(additionalData), hashCodeNullable(ibanFullname), hashCodeNullable(ibanBic), hashCodeNullable(dbtrIBAN), hashCodeNullable(mandateId), hashCodeNullable(ibanTxEndToEndId), payinId, hashCodeNullable(debtorName), hashCodeNullable(uniqueMandateReference));
  }
