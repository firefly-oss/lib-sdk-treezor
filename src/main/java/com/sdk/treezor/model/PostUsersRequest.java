 ...
 */
@JsonPropertyOrder({
  PostUsersRequest.JSON_PROPERTY_USER_TYPE_ID,
  PostUsersRequest.JSON_PROPERTY_USER_TAG,
  PostUsersRequest.JSON_PROPERTY_ACCESS_TAG,
  PostUsersRequest.JSON_PROPERTY_PARENT_USER_ID,
  PostUsersRequest.JSON_PROPERTY_PARENT_TYPE,
  PostUsersRequest.JSON_PROPERTY_SPECIFIED_U_S_PERSON,
  PostUsersRequest.JSON_PROPERTY_CONTROLLING_PERSON_TYPE,
  PostUsersRequest.JSON_PROPERTY_EMPLOYEE_TYPE,
  PostUsersRequest.JSON_PROPERTY_ENTITY_TYPE,
  PostUsersRequest.JSON_PROPERTY_TITLE,
  PostUsersRequest.JSON_PROPERTY_FIRSTNAME,
  PostUsersRequest.JSON_PROPERTY_LASTNAME,
  PostUsersRequest.JSON_PROPERTY_MIDDLE_NAMES,
  PostUsersRequest.JSON_PROPERTY_BIRTHDAY,
  PostUsersRequest.JSON_PROPERTY_EMAIL,
  PostUsersRequest.JSON_PROPERTY_ADDRESS1,
  PostUsersRequest.JSON_PROPERTY_ADDRESS2,
  PostUsersRequest.JSON_PROPERTY_ADDRESS3,
  PostUsersRequest.JSON_PROPERTY_POSTCODE,
  PostUsersRequest.JSON_PROPERTY_CITY,
  PostUsersRequest.JSON_PROPERTY_STATE,
  PostUsersRequest.JSON_PROPERTY_COUNTRY,
  PostUsersRequest.JSON_PROPERTY_DISTRIBUTION_COUNTRY,
  PostUsersRequest.JSON_PROPERTY_SECONDARY_ADDRESS1,
  PostUsersRequest.JSON_PROPERTY_SECONDARY_ADDRESS2,
  PostUsersRequest.JSON_PROPERTY_SECONDARY_ADDRESS3,
  PostUsersRequest.JSON_PROPERTY_SECONDARY_POSTCODE,
  PostUsersRequest.JSON_PROPERTY_SECONDARY_CITY,
  PostUsersRequest.JSON_PROPERTY_SECONDARY_STATE,
  PostUsersRequest.JSON_PROPERTY_SECONDARY_COUNTRY,
  PostUsersRequest.JSON_PROPERTY_PHONE,
  PostUsersRequest.JSON_PROPERTY_MOBILE,
  PostUsersRequest.JSON_PROPERTY_NATIONALITY,
  PostUsersRequest.JSON_PROPERTY_NATIONALITY_OTHER,
  PostUsersRequest.JSON_PROPERTY_PLACE_OF_BIRTH,
  PostUsersRequest.JSON_PROPERTY_BIRTH_COUNTRY,
  PostUsersRequest.JSON_PROPERTY_OCCUPATION,
  PostUsersRequest.JSON_PROPERTY_INCOME_RANGE,
  PostUsersRequest.JSON_PROPERTY_LEGAL_NAME,
  PostUsersRequest.JSON_PROPERTY_LEGAL_REGISTRATION_NUMBER,
  PostUsersRequest.JSON_PROPERTY_LEGAL_TVA_NUMBER,
  PostUsersRequest.JSON_PROPERTY_LEGAL_REGISTRATION_DATE,
  PostUsersRequest.JSON_PROPERTY_LEGAL_FORM,
  PostUsersRequest.JSON_PROPERTY_LEGAL_SHARE_CAPITAL,
  PostUsersRequest.JSON_PROPERTY_LEGAL_SECTOR,
  PostUsersRequest.JSON_PROPERTY_LEGAL_ANNUAL_TURN_OVER,
  PostUsersRequest.JSON_PROPERTY_LEGAL_NET_INCOME_RANGE,
  PostUsersRequest.JSON_PROPERTY_LEGAL_NUMBER_OF_EMPLOYEE_RANGE,
  PostUsersRequest.JSON_PROPERTY_EFFECTIVE_BENEFICIARY,
  PostUsersRequest.JSON_PROPERTY_LANGUAGE,
  PostUsersRequest.JSON_PROPERTY_TAX_NUMBER,
  PostUsersRequest.JSON_PROPERTY_TAX_RESIDENCE,
  PostUsersRequest.JSON_PROPERTY_POSITION,
  PostUsersRequest.JSON_PROPERTY_PERSONAL_ASSETS,
  PostUsersRequest.JSON_PROPERTY_ACTIVITY_OUTSIDE_EU,
  PostUsersRequest.JSON_PROPERTY_ECONOMIC_SANCTIONS,
  PostUsersRequest.JSON_PROPERTY_RESIDENT_COUNTRIES_SANCTIONS,
  PostUsersRequest.JSON_PROPERTY_INVOLVED_SANCTIONS,
  PostUsersRequest.JSON_PROPERTY_ENTITY_SANCTIONS_QUESTIONNAIRE,
  PostUsersRequest.JSON_PROPERTY_TIMEZONE,
  PostUsersRequest.JSON_PROPERTY_OCCUPATION_TYPE,
  PostUsersRequest.JSON_PROPERTY_SOURCE_OF_FUNDS,
  PostUsersRequest.JSON_PROPERTY_LEGAL_SECTOR_TYPE,
  PostUsersRequest.JSON_PROPERTY_IS_ON_STOCK_EXCHANGE,
  PostUsersRequest.JSON_PROPERTY_WEBAUTHN,
  PostUsersRequest.JSON_PROPERTY_PASSCODE,
  PostUsersRequest.JSON_PROPERTY_OCCUPATION_CATEGORY,
  PostUsersRequest.JSON_PROPERTY_PERSONAL_ASSETS_RANGE,
...
public class PostUsersRequest {
  ...
  private UserTypeIdEnum userTypeId = UserTypeIdEnum.NUMBER_1;
  ...
  public static final String JSON_PROPERTY_WEBAUTHN = "webauthn";
  @javax.annotation.Nullable
  ...
  /**
   * The User postal address (main). Cannot contain carriage return.  The following characters are accepted (uppercase or lowercase): * The 26 letters of the Roman alphabet * 16 letters with diacritical marks (À Â Ä Ç É È Ê Ë Î Ï Ô Ö Ù Û Ü Ÿ) * 2 ligatures (æ, œ) * Spaces, hyphens, apostrophes, or slashes « » / * Numeric characters 
   * @return address1
   */
  @javax.annotation.Nullable
  ...
  /**
   * The User secondary address country.  
  ...
  /**
   * The name of the legal entity.   If you&#39;re issuing cards, please not this value automatically populates the &#x60;embossedLegalName&#x60; field which has a max. length of 20 characters. 
   * @return legalName
   */
  @javax.annotation.Nullable
  ...
  /**
   * The User timezone in the [tz database](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) format. The timezones have unique names in the form \&quot;Area/Location\&quot;.  It may be used to enforce a card &#x60;paymentDailyLimit&#x60; based on the cardholder&#39;s timezone. 
   * @return timezone
   */
  @javax.annotation.Nullable
  ...
  /**
   * The &#x60;PublicKeyCredential&#x60; after the WebAuthn Register, encoded in base64.  See the [Web Native enrollment](/guide/strong-customer-authentication/user-enrollment.html#web-native-enrollment) article for more information. 
   * @return webauthn
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_WEBAUTHN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  /**
   * Required if the &#x60;webauthn&#x60; field is provided. Must be base64 encoded and encrypted. Initial passcode must at least 6 characters.  See the [Web Native enrollment](/guide/strong-customer-authentication/user-enrollment.html#web-native-enrollment) article for more information. 
   * @return passcode
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userTypeId, postUsersRequest.userTypeId) &&
        ...
        Objects.equals(this.accessTag, postUsersRequest.accessTag) &&
