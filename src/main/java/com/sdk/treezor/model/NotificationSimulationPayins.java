 ...
 */
@JsonPropertyOrder({
  NotificationSimulationPayins.JSON_PROPERTY_USER_ID,
  NotificationSimulationPayins.JSON_PROPERTY_WALLET_ID,
  NotificationSimulationPayins.JSON_PROPERTY_AMOUNT,
  NotificationSimulationPayins.JSON_PROPERTY_CURRENCY,
  NotificationSimulationPayins.JSON_PROPERTY_STATUS,
  NotificationSimulationPayins.JSON_PROPERTY_TRANSACTION_REFERENCE,
  NotificationSimulationPayins.JSON_PROPERTY_CARD_PAYMENT_METHOD,
  NotificationSimulationPayins.JSON_PROPERTY_PROFILE
})
...
public class NotificationSimulationPayins {
  ...
  public NotificationSimulationPayins amount(@javax.annotation.Nonnull Float amount) {
