 ...
 */
@JsonPropertyOrder({
  PostCardPhysicalRequest.JSON_PROPERTY_USER_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_ACCESS_TAG,
  PostCardPhysicalRequest.JSON_PROPERTY_WALLET_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_PERMS_GROUP,
  PostCardPhysicalRequest.JSON_PROPERTY_CARD_TAG,
  PostCardPhysicalRequest.JSON_PROPERTY_BATCH_DELIVERY_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_ATM_YEAR,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_ATM_MONTH,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_ATM_WEEK,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_ATM_DAY,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_ATM_ALL,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_PAYMENT_YEAR,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_PAYMENT_MONTH,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_PAYMENT_WEEK,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_PAYMENT_DAY,
  PostCardPhysicalRequest.JSON_PROPERTY_LIMIT_PAYMENT_ALL,
  PostCardPhysicalRequest.JSON_PROPERTY_PAYMENT_DAILY_LIMIT,
  PostCardPhysicalRequest.JSON_PROPERTY_PIN,
  PostCardPhysicalRequest.JSON_PROPERTY_CARD_PRINT,
  PostCardPhysicalRequest.JSON_PROPERTY_ANONYMOUS,
  PostCardPhysicalRequest.JSON_PROPERTY_SEND_TO_PARENT,
  PostCardPhysicalRequest.JSON_PROPERTY_MCC_RESTRICTION_GROUP_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_MERCHANT_RESTRICTION_GROUP_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_COUNTRY_RESTRICTION_GROUP_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_EMBOSS_LEGAL_NAME,
  PostCardPhysicalRequest.JSON_PROPERTY_LOGO_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_LOGO_BACK_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_DESIGN_CODE,
  PostCardPhysicalRequest.JSON_PROPERTY_PACKAGE_ID,
  PostCardPhysicalRequest.JSON_PROPERTY_DELIVERY_METHOD,
  PostCardPhysicalRequest.JSON_PROPERTY_PIN_MAILER,
  PostCardPhysicalRequest.JSON_PROPERTY_CUSTOMIZED_INFO,
  PostCardPhysicalRequest.JSON_PROPERTY_FREE_CUSTOMIZED_INFO,
  PostCardPhysicalRequest.JSON_PROPERTY_LETTER_CUSTOMIZED_INFO,
  PostCardPhysicalRequest.JSON_PROPERTY_CARD_LANGUAGES
})
@JsonTypeName("postCardPhysical_request")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-04-14T09:49:28.273669400+02:00[Europe/Paris]", comments = "Generator version: 7.12.0")
public class PostCardPhysicalRequest {
  ...
  public PostCardPhysicalRequest() {
  }

  public PostCardPhysicalRequest userId(@javax.annotation.Nonnull Integer userId) {
  ...
  public PostCardPhysicalRequest accessTag(@javax.annotation.Nullable String accessTag) {
  ...
  public PostCardPhysicalRequest walletId(@javax.annotation.Nonnull Integer walletId) {
  ...
  public PostCardPhysicalRequest permsGroup(@javax.annotation.Nonnull PermsGroupEnum permsGroup) {
  ...
  public PostCardPhysicalRequest cardTag(@javax.annotation.Nullable String cardTag) {
  ...
  /**
   * This attribute is a string which can store a maximum of 250 characters that you are free to populate to suit your needs  You can [read more about tags](/guide/api-basics/objects-tags.html) 
   * @return cardTag
   */
  @javax.annotation.Nullable
  ...
  public PostCardPhysicalRequest batchDeliveryId(@javax.annotation.Nullable Integer batchDeliveryId) {
  ...
  public PostCardPhysicalRequest limitAtmYear(@javax.annotation.Nullable Integer limitAtmYear) {
  ...
  public PostCardPhysicalRequest limitAtmMonth(@javax.annotation.Nullable Integer limitAtmMonth) {
  ...
  public PostCardPhysicalRequest limitAtmWeek(@javax.annotation.Nullable Integer limitAtmWeek) {
  ...
  public PostCardPhysicalRequest limitAtmDay(@javax.annotation.Nullable Integer limitAtmDay) {
  ...
  public PostCardPhysicalRequest limitAtmAll(@javax.annotation.Nullable Integer limitAtmAll) {
  ...
  public PostCardPhysicalRequest limitPaymentYear(@javax.annotation.Nullable Integer limitPaymentYear) {
  ...
  public PostCardPhysicalRequest limitPaymentMonth(@javax.annotation.Nullable Integer limitPaymentMonth) {
  ...
  public PostCardPhysicalRequest limitPaymentWeek(@javax.annotation.Nullable Integer limitPaymentWeek) {
  ...
  public PostCardPhysicalRequest limitPaymentDay(@javax.annotation.Nullable Integer limitPaymentDay) {
  ...
  public PostCardPhysicalRequest limitPaymentAll(@javax.annotation.Nullable Integer limitPaymentAll) {
  ...
  public PostCardPhysicalRequest paymentDailyLimit(@javax.annotation.Nullable Float paymentDailyLimit) {
  ...
  public PostCardPhysicalRequest pin(@javax.annotation.Nullable String pin) {
  ...
  public PostCardPhysicalRequest cardPrint(@javax.annotation.Nonnull String cardPrint) {
  ...
  public PostCardPhysicalRequest anonymous(@javax.annotation.Nullable Integer anonymous) {
  ...
  public PostCardPhysicalRequest sendToParent(@javax.annotation.Nullable SendToParentEnum sendToParent) {
  ...
  public PostCardPhysicalRequest mccRestrictionGroupId(@javax.annotation.Nullable Integer mccRestrictionGroupId) {
  ...
  public PostCardPhysicalRequest merchantRestrictionGroupId(@javax.annotation.Nullable Integer merchantRestrictionGroupId) {
  ...
  public PostCardPhysicalRequest countryRestrictionGroupId(@javax.annotation.Nullable Integer countryRestrictionGroupId) {
  ...
  public PostCardPhysicalRequest embossLegalName(@javax.annotation.Nullable Boolean embossLegalName) {
  ...
  public PostCardPhysicalRequest logoId(@javax.annotation.Nullable String logoId) {
  ...
  public PostCardPhysicalRequest logoBackId(@javax.annotation.Nullable String logoBackId) {
  ...
  public PostCardPhysicalRequest designCode(@javax.annotation.Nullable String designCode) {
  ...
  public PostCardPhysicalRequest packageId(@javax.annotation.Nullable String packageId) {
  ...
  public PostCardPhysicalRequest deliveryMethod(@javax.annotation.Nullable Integer deliveryMethod) {
  ...
  public PostCardPhysicalRequest pinMailer(@javax.annotation.Nullable PinMailerEnum pinMailer) {
  ...
  public PostCardPhysicalRequest customizedInfo(@javax.annotation.Nullable String customizedInfo) {
  ...
  public PostCardPhysicalRequest freeCustomizedInfo(@javax.annotation.Nullable String freeCustomizedInfo) {
  ...
  public PostCardPhysicalRequest letterCustomizedInfo(@javax.annotation.Nullable String letterCustomizedInfo) {
  ...
  public PostCardPhysicalRequest cardLanguages(@javax.annotation.Nullable String cardLanguages) {
  ...
  public boolean equals(Object o) {
    ...
    PostCardPhysicalRequest postCardPhysicalRequest = (PostCardPhysicalRequest) o;
    return Objects.equals(this.userId, postCardPhysicalRequest.userId) &&
        Objects.equals(this.accessTag, postCardPhysicalRequest.accessTag) &&
        Objects.equals(this.walletId, postCardPhysicalRequest.walletId) &&
        Objects.equals(this.permsGroup, postCardPhysicalRequest.permsGroup) &&
        Objects.equals(this.cardTag, postCardPhysicalRequest.cardTag) &&
        Objects.equals(this.batchDeliveryId, postCardPhysicalRequest.batchDeliveryId) &&
        Objects.equals(this.limitAtmYear, postCardPhysicalRequest.limitAtmYear) &&
        Objects.equals(this.limitAtmMonth, postCardPhysicalRequest.limitAtmMonth) &&
        Objects.equals(this.limitAtmWeek, postCardPhysicalRequest.limitAtmWeek) &&
        Objects.equals(this.limitAtmDay, postCardPhysicalRequest.limitAtmDay) &&
        Objects.equals(this.limitAtmAll, postCardPhysicalRequest.limitAtmAll) &&
        Objects.equals(this.limitPaymentYear, postCardPhysicalRequest.limitPaymentYear) &&
        Objects.equals(this.limitPaymentMonth, postCardPhysicalRequest.limitPaymentMonth) &&
        Objects.equals(this.limitPaymentWeek, postCardPhysicalRequest.limitPaymentWeek) &&
        Objects.equals(this.limitPaymentDay, postCardPhysicalRequest.limitPaymentDay) &&
        Objects.equals(this.limitPaymentAll, postCardPhysicalRequest.limitPaymentAll) &&
        Objects.equals(this.paymentDailyLimit, postCardPhysicalRequest.paymentDailyLimit) &&
        Objects.equals(this.pin, postCardPhysicalRequest.pin) &&
        Objects.equals(this.cardPrint, postCardPhysicalRequest.cardPrint) &&
        Objects.equals(this.anonymous, postCardPhysicalRequest.anonymous) &&
        Objects.equals(this.sendToParent, postCardPhysicalRequest.sendToParent) &&
        Objects.equals(this.mccRestrictionGroupId, postCardPhysicalRequest.mccRestrictionGroupId) &&
        Objects.equals(this.merchantRestrictionGroupId, postCardPhysicalRequest.merchantRestrictionGroupId) &&
        Objects.equals(this.countryRestrictionGroupId, postCardPhysicalRequest.countryRestrictionGroupId) &&
        Objects.equals(this.embossLegalName, postCardPhysicalRequest.embossLegalName) &&
        Objects.equals(this.logoId, postCardPhysicalRequest.logoId) &&
        Objects.equals(this.logoBackId, postCardPhysicalRequest.logoBackId) &&
        Objects.equals(this.designCode, postCardPhysicalRequest.designCode) &&
        Objects.equals(this.packageId, postCardPhysicalRequest.packageId) &&
        Objects.equals(this.deliveryMethod, postCardPhysicalRequest.deliveryMethod) &&
        Objects.equals(this.pinMailer, postCardPhysicalRequest.pinMailer) &&
        Objects.equals(this.customizedInfo, postCardPhysicalRequest.customizedInfo) &&
        Objects.equals(this.freeCustomizedInfo, postCardPhysicalRequest.freeCustomizedInfo) &&
        Objects.equals(this.letterCustomizedInfo, postCardPhysicalRequest.letterCustomizedInfo) &&
        Objects.equals(this.cardLanguages, postCardPhysicalRequest.cardLanguages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PostCardPhysicalRequest {\n");
